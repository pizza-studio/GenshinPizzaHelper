        ...
        NavigationView {
            List {
                ...
                Section (header: Text("如何添加小组件和锁屏小组件？").textCase(.none)) {
                    ...
                    NavigationLink(destination: WebBroswerView(url: "https://support.apple.com/HT205536").navigationTitle("如何添加复杂功能？").navigationBarTitleDisplayMode(.inline)) {
                        Label("关于如何在Apple Watch上添加复杂功能，请参考Apple支持文档", systemImage: "safari")
                            .padding(.vertical, 10)
                    }
                ...
                Section (header: Text("还有其他问题？").textCase(.none)) {
                    NavigationLink(destination: WebBroswerView(url: "https://ophelper.top/static/faq.html").navigationTitle("FAQ")) {
