...
extension ProxyServer: Vectorizable {
    ...
    public static func vecOfSelfGet(vecPtr: UnsafeMutableRawPointer, index: UInt) -> Optional<ProxyServerRef> {
    ...
    public static func vecOfSelfGetMut(vecPtr: UnsafeMutableRawPointer, index: UInt) -> Optional<ProxyServerRefMut> {
