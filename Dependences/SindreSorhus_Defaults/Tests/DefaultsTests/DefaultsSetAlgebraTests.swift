...
// MARK: Defaults.SetAlgebraSerializable
...
extension Defaults.Keys {
    ...
    fileprivate static let setAlgebraArray = Key<[DefaultsSetAlgebra<Int>]>(
        "setAlgebraArray",
        default: [.init([fixtureSetAlgebra])]
    )
    fileprivate static let setAlgebraDictionary = Key<[String: DefaultsSetAlgebra<Int>]>(
        "setAlgebraDictionary",
        default: ["0": .init([fixtureSetAlgebra])]
    )
}

// MARK: - DefaultsSetAlgebraTests
...
final class DefaultsSetAlgebraTests: XCTestCase {
    ...
    func testArrayKey() {
        let key = Defaults
            .Key<[DefaultsSetAlgebra<Int>]>("independentSetAlgebraArrayKey", default: [.init([fixtureSetAlgebra])])
    ...
    func testArrayDictionaryKey() {
        let key = Defaults
            .Key<[[String: DefaultsSetAlgebra<Int>]]>(
    ...
    func testObserveKeyCombine() {
        let key = Defaults
            .Key<DefaultsSetAlgebra<Int>>("observeSetAlgebraKeyCombine", default: .init([fixtureSetAlgebra]))
        ...
        let expectedValue: [(DefaultsSetAlgebra<Int>, DefaultsSetAlgebra<Int>)] = [
    ...
    func testObserveArrayKeyCombine() {
        let key = Defaults
            .Key<[DefaultsSetAlgebra<Int>]>("observeSetAlgebraArrayKeyCombine", default: [.init([fixtureSetAlgebra])])
        let expect = expectation(description: "Observation closure being called")
    ...
    func testObserveArrayKey() {
        let key = Defaults
            .Key<[DefaultsSetAlgebra<Int>]>("observeSetAlgebraArrayKey", default: [.init([fixtureSetAlgebra])])
        let expect = expectation(description: "Observation closure being called")
