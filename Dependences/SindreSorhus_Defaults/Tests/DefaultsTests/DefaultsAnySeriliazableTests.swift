...
extension Defaults.Keys {
    ...
    fileprivate static let anyDictionaryKey = Key<[String: Defaults.AnySerializable]>(
        "anyDictionaryKey",
        default: ["unicorn": "🦄"]
    )
}

// MARK: - DefaultsAnySerializableTests
...
final class DefaultsAnySerializableTests: XCTestCase {
    ...
    func testDictionaryKey() {
        let key = Defaults
            .Key<[String: Defaults.AnySerializable]>("independentDictionaryAnyKey", default: ["unicorn": ""])
    ...
    func testDictionaryArrayKey() {
        let key = Defaults
            .Key<[String: [Defaults.AnySerializable]]>("independentDictionaryArrayAnyKey", default: ["number": [1]])
    ...
    func testObserveOptionalKeyCombine() {
        ...
        let expectedValue: [(Defaults.AnySerializable?, Defaults.AnySerializable?)] = [
            (nil, 123),
            (123, "🦄"),
            ("🦄", nil),
        ]
