...
private let fixtureColor = UIColor(
    red: CGFloat(103) / CGFloat(0xFF),
    green: CGFloat(132) / CGFloat(0xFF),
    blue: CGFloat(255) / CGFloat(0xFF),
    alpha: 1
)
private let fixtureColor1 = UIColor(
    red: CGFloat(255) / CGFloat(0xFF),
    green: CGFloat(241) / CGFloat(0xFF),
    blue: CGFloat(180) / CGFloat(0xFF),
    alpha: 1
)
private let fixtureColor2 = UIColor(
    red: CGFloat(255) / CGFloat(0xFF),
    green: CGFloat(180) / CGFloat(0xFF),
    blue: CGFloat(194) / CGFloat(0xFF),
    alpha: 1
)
...
extension Defaults.Keys {
    ...
    fileprivate static let colorDictionary = Defaults
        .Key<[String: UIColor]>("NSColorArray", default: ["0": fixtureColor])
}
...
final class DefaultsNSColorTests: XCTestCase {
    ...
    func testArrayDictionaryKey() {
        let key = Defaults
            .Key<[[String: UIColor]]>("independentNSColorArrayDictionaryKey", default: [["0": fixtureColor]])
    ...
    func testDictionaryArrayKey() {
        let key = Defaults
            .Key<[String: [UIColor]]>("independentNSColorDictionaryArrayKey", default: ["0": [fixtureColor]])
        XCTAssertTrue(Defaults[key]["0"]?[0].isEqual(fixtureColor) ?? false)
        Defaults[key]["0"]?.append(fixtureColor1)
    ...
    func testObserveOptionalKeyCombine() {
        ...
        let expectedValue: [(UIColor?, UIColor?)] = [
            (nil, fixtureColor),
            (fixtureColor, fixtureColor1),
            (fixtureColor1, nil),
        ]
