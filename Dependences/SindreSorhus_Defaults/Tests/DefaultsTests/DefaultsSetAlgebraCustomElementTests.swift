...
extension Defaults.Keys {
    fileprivate static let setAlgebraCustomElement = Key<DefaultsSetAlgebra<Item>>(
        "setAlgebraCustomElement",
        default: .init([fixtureSetAlgebra])
    )
    fileprivate static let setAlgebraCustomElementArray = Key<[DefaultsSetAlgebra<Item>]>(
        "setAlgebraArrayCustomElement",
        default: [.init([fixtureSetAlgebra])]
    )
    fileprivate static let setAlgebraCustomElementDictionary =
        Key<[String: DefaultsSetAlgebra<Item>]>(
            "setAlgebraDictionaryCustomElement",
            default: ["0": .init([fixtureSetAlgebra])]
        )
}

// MARK: - DefaultsSetAlgebraCustomElementTests
...
final class DefaultsSetAlgebraCustomElementTests: XCTestCase {
    ...
    func testKey() {
        let key = Defaults
            .Key<DefaultsSetAlgebra<Item>>("independentSetAlgebraKey", default: .init([fixtureSetAlgebra]))
    ...
    func testArrayKey() {
        let key = Defaults
            .Key<[DefaultsSetAlgebra<Item>]>("independentSetAlgebraArrayKey", default: [.init([fixtureSetAlgebra])])
    ...
    func testNestedArrayKey() {
        let key = Defaults
            .Key<[[DefaultsSetAlgebra<Item>]]>(
                "independentSetAlgebraNestedArrayKey",
                default: [[.init([fixtureSetAlgebra])]]
            )
    ...
    func testArrayDictionaryKey() {
        let key = Defaults
            .Key<[[String: DefaultsSetAlgebra<Item>]]>(
                "independentSetAlgebraArrayDictionaryKey",
                default: [["0": .init([fixtureSetAlgebra])]]
            )
        Defaults[key][0]["0"]?.insert(fixtureSetAlgebra1)
    ...
    func testDictionaryKey() {
        let key = Defaults
            .Key<[String: DefaultsSetAlgebra<Item>]>(
                "independentSetAlgebraDictionaryKey",
                default: ["0": .init([fixtureSetAlgebra])]
            )
        Defaults[key]["0"]?.insert(fixtureSetAlgebra1)
    ...
    func testDictionaryArrayKey() {
        let key = Defaults
            .Key<[String: [DefaultsSetAlgebra<Item>]]>(
                "independentSetAlgebraDictionaryArrayKey",
                default: ["0": [.init([fixtureSetAlgebra])]]
            )
        Defaults[key]["0"]?[0].insert(fixtureSetAlgebra1)
        Defaults[key]["0"]?.append(.init([fixtureSetAlgebra1]))
    ...
    func testDictionaryType() {
        ...
        XCTAssertEqual(
            Defaults[.setAlgebraCustomElementDictionary]["0"],
            .init([fixtureSetAlgebra, fixtureSetAlgebra1])
        )
        XCTAssertEqual(
            Defaults[.setAlgebraCustomElementDictionary]["1"],
            .init([fixtureSetAlgebra2, fixtureSetAlgebra3])
        )
    }

    func testObserveKeyCombine() {
        let key = Defaults
            .Key<DefaultsSetAlgebra<Item>>("observeSetAlgebraKeyCombine", default: .init([fixtureSetAlgebra]))
        ...
        let expectedValue: [(DefaultsSetAlgebra<Item>, DefaultsSetAlgebra<Item>)] = [
            (.init([fixtureSetAlgebra]), .init([fixtureSetAlgebra, fixtureSetAlgebra1])),
            (.init([fixtureSetAlgebra, fixtureSetAlgebra1]), .init([fixtureSetAlgebra])),
        ]
    ...
    func testObserveOptionalKeyCombine() {
        ...
        let expectedValue: [(DefaultsSetAlgebra<Item>?, DefaultsSetAlgebra<Item>?)] = [
            (nil, .init([fixtureSetAlgebra])),
            (.init([fixtureSetAlgebra]), .init([fixtureSetAlgebra, fixtureSetAlgebra1])),
            (.init([fixtureSetAlgebra, fixtureSetAlgebra1]), nil),
        ]
    ...
    func testObserveArrayKeyCombine() {
        let key = Defaults
            .Key<[DefaultsSetAlgebra<Item>]>("observeSetAlgebraArrayKeyCombine", default: [.init([fixtureSetAlgebra])])
        let expect = expectation(description: "Observation closure being called")
    ...
    func testObserveDictionaryKeyCombine() {
        let key = Defaults
            .Key<[String: DefaultsSetAlgebra<Item>]>(
                "observeSetAlgebraDictionaryKeyCombine",
                default: ["0": .init([fixtureSetAlgebra])]
            )
        let expect = expectation(description: "Observation closure being called")
    ...
    func testObserveArrayKey() {
        let key = Defaults
            .Key<[DefaultsSetAlgebra<Item>]>("observeSetAlgebraArrayKey", default: [.init([fixtureSetAlgebra])])
        let expect = expectation(description: "Observation closure being called")
    ...
    func testObserveDictioanryKey() {
        let key = Defaults
            .Key<[String: DefaultsSetAlgebra<Item>]>(
                "observeSetAlgebraDictionaryKey",
                default: ["0": .init([fixtureSetAlgebra])]
            )
        let expect = expectation(description: "Observation closure being called")
