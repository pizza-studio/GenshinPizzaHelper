...
extension Defaults {
    public struct SetBridge<Element: Serializable & Hashable>: Bridge {
        ...
        public func deserialize(_ object: Serializable?) -> Value? {
            ...
            guard let array = object as? [Element.Serializable],
...
extension Defaults {
    public struct RangeBridge<T: RangeSerializable>: Bridge {
        ...
        public func serialize(_ value: Value?) -> Serializable? {
            ...
            guard let lowerBound = Bound.bridge.serialize(value.lowerBound as? Bound.Value),
        ...
        public func deserialize(_ object: Serializable?) -> Value? {
            ...
            if Bound.isNativelySupportedType {
                guard let lowerBound = object[safe: 0] as? Bound,
            ...
            guard let lowerBound = Bound.bridge.deserialize(object[safe: 0] as? Bound.Serializable) as? Bound,
...
extension Defaults {
    ...
    public struct ColorBridge: Bridge {
        ...
        public func serialize(_ value: Value?) -> Serializable? {
            ...
            guard let cgColor = value.cgColor,
        ...
        public func deserialize(_ object: Serializable?) -> Value? {
            ...
            guard let object = object as? [Any],
