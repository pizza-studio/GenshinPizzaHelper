...
extension MiHoYoAPI {
    ...
    public static func sTokenV2(cookie: String) async throws -> String {
        let request = try await generateRequest(httpMethod: .post, region: .china, host: "passport-api.mihoyo.com", path: "/account/ma-cn-session/app/getTokenBySToken", queryItems: [], cookie: cookie, additionalHeaders: ["x-rpc-app_id": "bll8iq97cem8"])
