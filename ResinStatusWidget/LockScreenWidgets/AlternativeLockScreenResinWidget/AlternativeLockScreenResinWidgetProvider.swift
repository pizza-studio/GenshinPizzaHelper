...
struct AlternativeLockScreenResinWidgetProvider: IntentTimelineProvider {
    ...
    func recommendations() -> [IntentRecommendation<SelectOnlyAccountIntent>] {
        ...
        return configs.map { config in
            ...
            return IntentRecommendation(intent: intent, description: config.name!+"的原粹树脂".localized)
        }
    }
