...
extension EnkaGI.FightPropMap {
    ...
    var allPairedDMGBoostsRanked: [PairedDamageAmpIntel] {
        PlayerDetail.Avatar.TeyvatElement.allCases.map { currentElement in
            getPairedDamageAmpIntel(for: currentElement)
        }.sorted { $0.amount > $1.amount }
    }

    public func getPairedDamageAmpIntel(for element: PlayerDetail.Avatar.TeyvatElement) -> PairedDamageAmpIntel {
        switch element {
    ...
    public func baseDMGBoostIntel(for element: PlayerDetail.Avatar.TeyvatElement) -> PairedDamageAmpIntel {
        getPairedDamageAmpIntel(for: element)
    }

    public func highestDMGBoostIntel(for element: PlayerDetail.Avatar.TeyvatElement) -> PairedDamageAmpIntel {
    ...
    public func isPhysicoDMGBoostSecondarilyEffective(for element: PlayerDetail.Avatar.TeyvatElement) -> Bool {
